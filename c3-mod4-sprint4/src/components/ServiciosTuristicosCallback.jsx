...
const ServiciosTuristicosCallback = () => {
  ...
  useEffect(() => {
    fetchTuristicos();
  }, [fetchTuristicos]); // <- dependencias del useEffect;
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl font-bold mb-6">Servicios Turísticos Callback</h1>
      {loading && (
...
export default ServiciosTuristicosCallback;
